...
const Hero = () => (
  <section
    id="home"
    style={{ paddingTop: "48px", paddingBottom: "64px", backgroundColor: "var(--retro-center-bg)" }}
  >
    <Container>
      <div className="flex flex-col items-center text-center gap-6" style={{ maxWidth: "560px", margin: "0 auto" }}>
        ...
        <div className="retro-divider" style={{ width: "100%" }}>★</div>

        <p
          className="text-base leading-relaxed"
          style={{ color: "var(--retro-black)", opacity: 0.75 }}
        >
